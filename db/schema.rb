...
ActiveRecord::Schema[7.1].define(version: 2025_04_12_204027) do
  ...
  create_table "whishlists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_id"], name: "index_whishlists_on_property_id"
    t.index ["user_id", "property_id"], name: "index_whishlists_on_user_id_and_property_id", unique: true
  ...
  add_foreign_key "whishlists", "properties"
